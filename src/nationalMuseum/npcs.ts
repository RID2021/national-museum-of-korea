...
export const NATIONAL_MUSEUM_NPCS: MissionNpcDefinition[] = [
  ...
  npc("guide-robot", "상설전시관 로비", "전시실 안내, 관람 예절, 회의와 긴급 상황", [
    ...
    },
    {
      id: "silla-guide",
      title: "신라실 안내",
      lines: ["다음은 신라실입니다. 신라실은 1층에 위치해 있습니다. 화살표를 따라가세요."],
    },
    {
      id: "etiquette-intro",
      title: "관람 예절 미션 안내",
  ...
  npc("baekje-landscape-brick", "백제실", "백제 문양전 배열과 미술 안내", [
    {
      ...
      oncePerPlayer: true,
      lines: [
        "나는 백제 사비시대를 대표하는 산수문전 벽돌이야.",
        "산과 나무, 물과 바위, 그리고 구름이 표현되어 있지.",
        "하지만 지금은 전시된 벽돌의 배열이 흐트러져 있어.",
        "밤이 되면서 마법에 오류가 생긴 것 같아.",
        "원래 위치로 맞춰주면 8개 벽돌을 대표해서 내가 오늘 회의에 참석할 수 있을 것 같아.",
        "현재 공간에 있는 벽돌 8개를 찾아서 순서를 맞춰줘.",
      ],
    },
    { id: "brick-yeondaegwi", title: "연대귀문전 확인", lines: ["연대귀문전이다. 연꽃 받침(연대) 위에 도깨비 얼굴(귀문)이 있는 벽돌이다."], museumTransitionId: "baekje-brick:yeondaegwi" },
    { id: "brick-sansu", title: "산수문전 확인", lines: ["산수문전이다. 산, 물, 바위, 나무, 구름 등 풍경이 표현된 벽돌이다."], museumTransitionId: "baekje-brick:sansu" },
    { id: "brick-waun", title: "와운문전 확인", lines: ["와운문전이다. 소용돌이치듯 흐르는 구름무늬가 표현된 벽돌이다."], museumTransitionId: "baekje-brick:waun" },
    { id: "brick-sansubonghwang", title: "산수봉황문전 확인", lines: ["산수봉황문전이다. 산수 배경 안에 봉황이 함께 있는 벽돌이다."], museumTransitionId: "baekje-brick:sansubonghwang" },
    { id: "brick-bonghwang", title: "봉황문전 확인", lines: ["봉황문전이다. 봉황이 중심으로 들어간 벽돌이다."], museumTransitionId: "baekje-brick:bonghwang" },
    { id: "brick-sansugwi", title: "산수귀문전 확인", lines: ["산수귀문전이다. 산수 배경 안에 도깨비 얼굴(귀문)이 있는 벽돌이다."], museumTransitionId: "baekje-brick:sansugwi" },
    { id: "brick-banryong", title: "반룡문전 확인", lines: ["반룡문전이다. 몸을 둥글게 튼 용이 표현된 벽돌이다."], museumTransitionId: "baekje-brick:banryong" },
    { id: "brick-yeonhwa", title: "연화문전 확인", lines: ["연화문전이다. 연꽃무늬가 중심인 벽돌이다."], museumTransitionId: "baekje-brick:yeonhwa" },
    {
      id: "success",
      title: "산수문전 벽돌 미션 후 대화",
      museumTransitionId: "museum-baekje-bricks",
      lines: [
        "잘했어! 벽돌에 담긴 산과 물, 구름과 봉황 무늬는 백제인의 자연관과 세련된 미술 감각을 보여준다고!",
        "다음 공간으로 이동해보자!",
      ],
    },
...
const KOREAN_ALIASES: Record<MuseumCharacterId, string[]> = {
  ...
  "baekje-landscape-brick": ["산수무늬벽돌", "산수문전벽돌"],
