...
export const PLACES = [
  ...
  { name: "황초령 순수비", description: "함경남도 황초령. 신라의 세력이 동북쪽으로 뻗었음을 보여 줍니다.", x: 73, y: 29 },
  { name: "마운령 순수비", description: "함경남도 마운령. 황초령비와 함께 동북 지역 진출을 알려 줍니다.", x: 83, y: 22 },
  { name: "단양 적성비", description: "충북 단양. 새로 확보한 지역의 주민을 포상한 기록이 남아 있습니다. 순수비와 구분해 보세요.", x: 60, y: 66 },
];
export const PAIRS = [
