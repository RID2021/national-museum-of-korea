...
export const DEFAULT_MOVE_SPEED = 90;
export const DEFAULT_HORSE_MOVE_SPEED = 160;
export const HORSE_LIFETIME = 18;
...
export const USER_TARGET_X_OVERRIDE: number | null = 6;
export const HORSE_SPAWN_X_OVERRIDE: number | null = null;
export const HORSE_TARGET_X_OVERRIDE: number | null = 8;
