...
const BUILD_DEBUG = Object.prototype.hasOwnProperty.call(process.env, "ZEP_DEBUG") ? process.env.ZEP_DEBUG : "";
...
module.exports = {
    ...
    plugins: [
        new SequentialChunkRenamerPlugin(),
        new webpack.DefinePlugin({
            "process.env.NODE_ENV": JSON.stringify(BUILD_ENV),
            "process.env.ZEP_DEBUG": JSON.stringify(BUILD_DEBUG),
        }),
    ],
};
